...
def main():
	...
	if choice == "Home":
		...
		st.write("- The gradient magnitude is a metric for determining how significant a change in image intensity is. It is a real-valued quantity that expresses the 'strength' of an intensity variation.")
